...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float verticalRotationMouseSpeed =30f;
        ...
        private void Rotation()
        {
            ...
            if (useMouseRotation && Input.GetKey(mouseRotationKey))
                m_Transform.Rotate(Vector3.right, -MouseAxis.y * Time.deltaTime * mouseRotationSpeed, Space.Self);
        }
        ...
        {   
           ...
           // _yaw += inputDelta.x * verticalRotationMouseSpeed * Time.deltaTime; 

            /*        
            localRot.y += Input.GetAxis("Mouse Y")*verticalRotationMouseSpeed;
            Debug.Log(localRot.y);
            localRot.y = Mathf.Clamp(localRot.y, 15f, 80f);
            Quaternion QT = Quaternion.Euler(transform.rotation.x, localRot.y, 0f);
            transform.rotation = Quaternion.Lerp(transform.rotation, QT, Time.deltaTime );
            */
        }
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, 0, limitX),
                ...
                Mathf.Clamp(m_Transform.position.z, 0, limitY));
        }
